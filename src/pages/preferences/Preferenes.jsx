...
export const Preferenes = () => {
  ...
  return (
    <div className="display-flex mx-24 dark:bg-dm">
      <Route>
        <Route>
          <Link to="homepage" className="font-bold text-lg mb-5">
            Back
          </Link>
        </Route>
      </Route>
      ...
      <div className="display-flex ml-24 justify-center">
        <button className="bg-pickle p-6 py-3 rounded-xl text-center">Submit</button>
      </div>
    </div>
  );
};
